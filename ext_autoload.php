...
return array (
    ...
    'tx_dlf_document' => $extensionPath.'Classes/Common/class.tx_dlf_document.php',
    'tx_dlf_format' => $extensionPath.'Classes/Common/class.tx_dlf_format.php',
    'tx_dlf_fulltext' => $extensionPath.'Classes/Common/class.tx_dlf_fulltext.php',
    'tx_dlf_helper' => $extensionPath.'Classes/Common/class.tx_dlf_helper.php',
    'tx_dlf_indexing' => $extensionPath.'Classes/Common/class.tx_dlf_indexing.php',
    'tx_dlf_list' => $extensionPath.'Classes/Common/class.tx_dlf_list.php',
    'tx_dlf_module' => $extensionPath.'Classes/Common/class.tx_dlf_module.php',
    'tx_dlf_plugin' => $extensionPath.'Classes/Common/class.tx_dlf_plugin.php',
    'tx_dlf_solr' => $extensionPath.'Classes/Common/class.tx_dlf_solr.php',
    'tx_dlf_alto' => $extensionPath.'Classes/Formats/class.tx_dlf_alto.php',
    'tx_dlf_mods' => $extensionPath.'Classes/Formats/class.tx_dlf_mods.php',
    'tx_dlf_teihdr' => $extensionPath.'Classes/Formats/class.tx_dlf_teihdr.php',
    'tx_dlf_doctype' => $extensionPath.'Classes/Hooks/class.tx_dlf_doctype.php',
    'tx_dlf_em' => $extensionPath.'Classes/Hooks/class.tx_dlf_em.php',
    'tx_dlf_hacks' => $extensionPath.'Classes/Hooks/class.tx_dlf_hacks.php',
    'tx_dlf_tceforms' => $extensionPath.'Classes/Hooks/class.tx_dlf_tceforms.php',
    'tx_dlf_tcemain' => $extensionPath.'Classes/Hooks/class.tx_dlf_tcemain.php',
