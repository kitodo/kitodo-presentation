...
class FulltextTool extends \Kitodo\Dlf\Common\AbstractPlugin
{
    ...
    public function main($content, $conf)
    {
        ...
        if (!empty($fullTextFile)) {
            $markerArray['###FULLTEXT_SELECT###'] = '<a class="select switchoff" id="tx-dlf-tools-fulltext" title="" data-dic="fulltext:' . htmlspecialchars($this->pi_getLL('fulltext', '')) . ';fulltext-on:' . htmlspecialchars($this->pi_getLL('fulltext-on', '')) . ';fulltext-off:' . htmlspecialchars($this->pi_getLL('fulltext-off', '')) . ';activate-full-text-initially:' . $this->conf['activateFullTextInitially'] .'">&nbsp;</a>';
        } else {
