...
class OaiPmh extends \Kitodo\Dlf\Common\AbstractPlugin
{
    ...
    public function main($content, $conf)
    {
        ...
        if (!empty($this->conf['stylesheet'])) {
            ...
            $stylesheet = GeneralUtility::locationHeaderUrl(PathUtility::stripPathSitePrefix(ExtensionManagementUtility::extPath($this->extKey)) . 'Resources/Public/Stylesheets/OaiPmh/OaiPmh.xsl');
        }
