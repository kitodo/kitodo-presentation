...
final class TenantDefaultsSetupService
{
    ...
    /**
     * @param array<string, array<string, array<int, array<string, string>>>> $langArray
     */
    private function getLocalizedLabel(string $index, string $lang, array $langArray): string
    {
    ...
    private function getRecords(string $recordType): array
    {
        ...
        $fileContents = GeneralUtility::getUrl($filePath);
